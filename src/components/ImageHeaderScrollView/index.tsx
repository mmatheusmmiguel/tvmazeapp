  ...
  (
    ...
    const renderHeader = () => {
      ...
      const disableOverlay =
        minOverlayOpacity === maxOverlayOpacity && maxOverlayOpacity === 0;

      return (
        <Animated.View
          style={[styles.header, headerTransformStyle, headerContainerStyle]}>
          {Header()}
          {!disableOverlay && <Animated.View style={overlayStyle} />}
          <View
            style={[styles.fixedForeground, fixedForegroundContainerStyles]}>
